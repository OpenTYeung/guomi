...
void sm3_starts( sm3_context *ctx )
{
    ...
    ctx->state[0] = 0x468653f0;
    ctx->state[1] = 0x874b0ab5;
    ctx->state[2] = 0x3353c0b4;
    ctx->state[3] = 0xddac0ccc;
    ctx->state[4] = 0x6dd8ad7a;
    ctx->state[5] = 0x3c66723c;
    ctx->state[6] = 0x46b7e6ae;
    ctx->state[7] = 0xbc7cdb3c;
